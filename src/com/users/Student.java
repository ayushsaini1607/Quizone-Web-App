...
public class Student implements User {
        ...
        public static Student search(String username)
        {
        	Connection con=null;
        	...
        	try {
        		...
        		if(resultSet.next())
        		{
	        		Student student = new Student(username,resultSet.getString("password"));
        	...
        	try {
        		...
        		if(update)
        		{
        			statement.executeUpdate("update users set email='" + email 
        					+ "',userType='student',fname='" + fname + "',lname='"
        		...
        		else
        		{
	            	statement.executeUpdate("insert into users values ('" + username + "' , '" 
	            			+ email + "' , '" + password.getPassword() + "','student', '" 
	            			+ fname + "' , '" + lname + "')");	
